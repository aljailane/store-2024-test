                ...
                <div class="col-md-4 mb-4">
                    <div class="order-card">
                        ...
                        <div class="text-center">
                            ...
                            <a href="action.php?order=<?php echo $order['order_id']; ?>&status=2" class="btn btn-danger btn-cancel-order" onclick="return confirmCancelOrder('<?php echo $order['order_id']; ?>')">Cancel Order</a>
                        </div>
...
<script>
    function confirmCancelOrder(orderId) {
        return confirm('هل أنت متأكد من رغبتك في إلغاء الطلب؟');
    }
</script>
